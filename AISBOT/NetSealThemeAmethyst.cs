...
class NSButton : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        PT1 = new PointF((Width - (int)SZ1.Width) / 2, Height / 2 - SZ1.Height / 2);
...
class NSProgressBar : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        if (I1 > 1)
        {
            ...
            GB2 = new LinearGradientBrush(R2, Color.FromArgb(46, 204, 113), Color.FromArgb(150, 110, 0), 90f);
...
class NSLabel : Control
{
    ...
    public NSLabel()
    {
        ...
        B1 = new SolidBrush(Color.FromArgb(46, 204, 113));
    }
...
class NSTextBox : Control
{
    ...
    void Base_MouseUp(object sender, MouseEventArgs e)
    {
        if (MouseUpFix != null)
            MouseUpFix(sender, e);
    }
    ...
    private void OnBaseTextChanged(object s, EventArgs e)
    {
        ...
        if (NumbersOnly && Base.Text != "" && (!int.TryParse(Base.Text, out n) || n < NumberBounds.X || n > NumberBounds.Y))
        {
...
class NSTabControl : TabControl
{
    ...
    public NSTabControl()
    {
        ...
        B3 = new SolidBrush(Color.FromArgb(46, 204, 113));
...
class NSOnOffBox : Control
{
    ...
    public NSOnOffBox()
    {
        ...
        B4 = new SolidBrush(Color.FromArgb(46, 204, 113));
...
class NSTrackBar : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        GB2 = new LinearGradientBrush(R3, Color.FromArgb(46, 204, 113), Color.FromArgb(150, 110, 0), 90f);
...
public class NSListView : Control
{
    ...
    public class NSListViewItem
    {
        ...
        public NSListViewItem(NSListView parent)
        {
    ...
    {
        AddItem(text, null, null, subItems);
    }
    ...
    public void AddItem(string text, Image icon, object tag, params string[] subItems)
    {
        ...
        NSListViewItem Item = new NSListViewItem(this);
        Item.Text = text;
        Item.Icon = icon;
        Item.Tag = tag;
        Item.SubItems = Items;
    ...
    protected override void OnMouseDown(MouseEventArgs e)
    {
        ...
        if (e.Button == System.Windows.Forms.MouseButtons.Left || (e.Button == System.Windows.Forms.MouseButtons.Right && _SelectedItems.Count <= 1))
        {
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int I = StartIndex; I <= EndIndex; I++)
        {
            ...
            if (CI.Icon != null)
            {
                double scale = (double)(ItemHeight - imageMarginY) / CI.Icon.Height;
                imageWidth = (int)(scale * CI.Icon.Width);
            ...
            G.DrawString(CI.Text, Font, Brushes.White, imageWidth + imageMarginX / 2, Y);
